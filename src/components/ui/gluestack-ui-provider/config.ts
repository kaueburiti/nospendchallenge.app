...
export const config = {
  ...
  dark: vars({
    ...
    /* Success */
    '--color-success-0': '8 71 57',
    '--color-success-50': '12 89 71',
    '--color-success-100': '16 107 85',
    '--color-success-200': '20 143 114',
    '--color-success-300': '22 161 128',
    '--color-success-400': '24 179 142',
    '--color-success-500': '26 188 156',
    '--color-success-600': '42 204 172',
    '--color-success-700': '57 219 188',
    '--color-success-800': '73 235 204',
    '--color-success-900': '89 250 220',
    '--color-success-950': '204 253 241',
